...
function SQLDatabase(inpCallback) {
    ...
    this.database = window.openDatabase("CoJooooaaAFAFGfFF", "1.0", "CojooooaaAFAFFFfF", 200000, this.databaseReady.bind(this));
...
SQLDatabase.prototype = {
    ...
    executeCreate: function(tx) {
        tx.executeSql(this.currentStatement, [], this.executeCreateComplete.bind(this), this.executeCreateError);
    },
    ...
    executeCreateError: function(tx, err) {
